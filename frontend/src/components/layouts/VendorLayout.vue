<template>
  <div class="min-h-screen bg-gray-100 flex">
    <!-- Sidebar -->
    <aside
      class="bg-white w-64 flex-shrink-0 border-r border-gray-200 flex flex-col transition-all duration-300 fixed md:relative h-screen z-50 md:z-auto"
      :class="{
        '-translate-x-full md:translate-x-0 md:-ml-64': !isSidebarOpen,
    ...
    >
      ...
      >
        <router-link to="/" class="flex items-center gap-2">
          <div
            class="w-8 h-8 bg-green-600 rounded-lg flex items-center justify-center text-white font-bold text-xl"
          >
            V
          </div>
      ...
      <div class="p-4 border-t border-gray-200">
        <div class="flex items-center">
          <div class="flex-shrink-0">
            <div
              class="h-8 w-8 rounded-full bg-gray-300 flex items-center justify-center text-gray-600 font-bold"
            >
              {{ userInitials }}
            </div>
          </div>
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
      ...
      <header class="bg-white shadow-sm z-10">
        <div
          class="px-4 sm:px-6 lg:px-8 h-16 flex justify-between items-center"
        >
          <button
