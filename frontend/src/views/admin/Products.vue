          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <tr v-for="product in products" :key="product._id" class="hover:bg-gray-50">
              <td class="px-6 py-4 whitespace-nowrap">
                <div class="flex items-center">
                  <div class="h-10 w-10 flex-shrink-0">
                    <img class="h-10 w-10 rounded object-cover" :src="product.images?.[0] || 'https://via.placeholder.com/40'" alt="" />
                  </div>
                  <div class="ml-4">
              ...
              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                <div class="font-medium text-gray-900">{{ product.vendor?.businessName || 'Unknown' }}</div>
                <div class="text-xs text-gray-400">{{ product.vendor?.email }}</div>
              </td>
