<template>
  <VendorLayout>
    <div class="max-w-4xl mx-auto space-y-6">
      ...
      <div class="card">
        <h2 class="text-lg font-semibold mb-4">Manual Mobile Money Configuration</h2>
        <p class="text-sm text-gray-600 mb-6">
          Configure your MTN and Airtel Mobile Money numbers for receiving manual payments from customers.
          These numbers will be displayed to customers when they choose "Manual Mobile Money" at checkout.
        </p>
        ...
        <form @submit.prevent="savePaymentConfig" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
                />
                <p class="text-xs text-gray-500 mt-1">Name registered on MTN account</p>
              </div>
            </div>
          </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
                />
                <p class="text-xs text-gray-500 mt-1">Name registered on Airtel account</p>
              </div>
            </div>
          </div>
          ...
          <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <ul class="text-sm text-blue-800 space-y-1">
              <li>• Customers will see these numbers when they choose "Manual Mobile Money"</li>
              <li>• They send money to your number and submit the Transaction ID</li>
              <li>• You verify the payment in your mobile money app</li>
              <li>• Confirm the payment in the admin panel to complete the order</li>
            </ul>
          </div>
      ...
      <div class="card bg-gray-50">
        <h2 class="text-lg font-semibold mb-4">Preview - What Customers Will See</h2>
        <div class="bg-white rounded-lg border-2 border-blue-300 p-4">
          ...
          <div class="space-y-3">
            <div>
              ...
              <p class="text-xl font-bold text-yellow-600">{{ paymentConfig.mtnNumber || '+256777123456' }}</p>
              <p class="text-xs text-gray-500">Name: {{ paymentConfig.mtnAccountName || 'Your Business' }}</p>
            </div>
            <div class="border-t pt-3">
              <p class="text-xs text-gray-600 mb-1">Airtel Money</p>
              <p class="text-xl font-bold text-red-600">{{ paymentConfig.airtelNumber || '+256752123456' }}</p>
              <p class="text-xs text-gray-500">Name: {{ paymentConfig.airtelAccountName || 'Your Business' }}</p>
            </div>
          </div>
        </div>
      </div>
...
const loadCurrentConfig = async () => {
  try {
    ...
    paymentConfig.value = {
      ...
      airtelAccountName: config.airtelAccountName || response.data.businessName || ''
    };
  } catch (err) {
